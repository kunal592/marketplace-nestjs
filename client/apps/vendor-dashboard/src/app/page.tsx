  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Here is what's happening with your store today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="h-80 flex items-center justify-center border-t bg-zinc-50/50 dark:bg-zinc-900/10 rounded-b-xl">
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center justify-between border-b last:border-0 pb-4 last:pb-0">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">kunal@example.com</p>
                  </div>
